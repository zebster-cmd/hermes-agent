...
ALL_TOOL_SCHEMAS = [PROFILE_SCHEMA, SEARCH_SCHEMA, REASONING_SCHEMA, CONTEXT_SCHEMA, CONCLUDE_SCHEMA, PEERS_SCHEMA, WORKSPACE_SCHEMA]
...
>>>>>>> origin/live
                ...
                if action == "get":
                    ...
                    if not workspace_id:
                        return tool_error("Missing 'workspace_id' for create action.")
                    try:
